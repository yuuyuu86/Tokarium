...
(() => {
  ...
  const EN = {
    ...
    "how.s1.t": "Use AI as usual", "how.s1.p": "Tokarium uses only the token counts in usage records on this Mac. Nothing else to do.",
    ...
    "how.aside": "Only usage after you install counts. Your conversations are never used.",
    ...
    "play.layout.p": "57 decorations. Hunt for combo bonuses like Japanese Garden and Sunken Treasure.",
    ...
    "privacy.eyebrow": "Privacy", "privacy.title": "Just the numbers",
    "privacy.p1": "Only token counts, times and IDs to avoid double counting. Your conversations are never used, stored or sent.",
    "privacy.p2": "Everything stays on this Mac. The only network request is the update check. API keys and cookies are never touched.",
    ...
    "install.3": "Open it, choose which AI to read, and click <b>Get Started</b>",
    ...
    "faq.q3": "Can I keep one tank on several Macs?", "faq.a3": "Yes. Turn on iCloud Drive sync, and your coins include AI usage from every Mac.",
    "faq.q4": "How do I uninstall it?", "faq.a4": "Move Tokarium to the Trash. To remove its data too, delete <code>~/Library/Application Support/Tokarium</code>. If you installed with Homebrew, <code>brew uninstall --zap --cask tokarium</code> removes everything.",
